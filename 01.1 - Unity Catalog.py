...
# MAGIC %md
# MAGIC # Access Control Hive Metastore (legacy)
# MAGIC
# MAGIC [Documentation - Hive metastore privileges and securable objects](https://learn.microsoft.com/en-gb/azure/databricks/data-governance/table-acls/object-privileges)
# MAGIC
# MAGIC [Documentation - Enable Hive metastore table access control on a cluster](https://learn.microsoft.com/en-us/azure/databricks/data-governance/table-acls/table-acl)
